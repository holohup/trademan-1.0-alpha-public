...
EVENING_TRADED_STOCKS = (
    ...
    'RNFT', 'ROSN', 'RTKM', 'RTKMP', 'RUAL', 'SBER', 'SBERP', 'SELG', 'SGZH',
    'SIBN', 'SMLT', 'SNGS', 'SNGSP', 'SOFL', 'SPBE', 'SVAV', 'SVCB', 'TATN',
    'TATNP', 'TCSG', 'TGKA', 'TRMK', 'TRNFP', 'UNAC', 'UPRO', 'UWGN', 'VKCO',
    'VSMO', 'VTBR', 'WUSH', 'YDEX', 'ZAYM'
)
